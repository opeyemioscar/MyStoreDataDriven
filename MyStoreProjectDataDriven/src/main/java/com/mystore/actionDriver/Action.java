...
public class Action extends BaseClass {
	...
	public void scrollByVisibilityOfElement(WebDriver driver, WebElement ele) {
		...
		js.executeScript("argumentss[0].scrollIntoView();", ele);
	...
	public String screenShot(WebDriver driver, String filename) {
		...
		String newImageString = "http://localhost:8080/job/MyStoreProject/ws/MyStoreProjectDataDriven/ScreenShots/" + filename + "_"
				+ dateName + ".png";
